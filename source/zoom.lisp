...
(define-command zoom-in-page ()
  ...
  (buffer-evaluate-javascript *interface* (buffer-active *interface*) (%zoom-in-page)))

(define-command zoom-out-page ()
  "Zoom out the current page."
  (buffer-evaluate-javascript *interface* (buffer-active *interface*) (%zoom-out-page)))

(define-command unzoom-page ()
  "Unzoom the page."
  (buffer-evaluate-javascript *interface* (buffer-active *interface*) (%unzoom-page)))
