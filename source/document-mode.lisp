...
(define-mode document-mode (mode)
  ...
  (define-key *document-mode-map* (key "C-l") 'set-url-active-buffer)
  (define-key *document-mode-map* (key "C-r") 'reload-active-buffer)
...
(defun history-forwards-completion-fn ()
  ...
  (let* ((mode (mode (buffer-active *interface*)))
